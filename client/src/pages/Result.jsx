  ...
  return (
    ...
    <div>
      <div className='relative'>
        <img className='max-w-sm border-rounded' src={image} alt="" />
    ...
    <div className='flex w-full max-w-xl text-white bg-neutral-500 text-sm p-0.5 mt-10 rounded-full'>
      ...
      <button type='submit' className='bg-zinc-900 sm:px-16 px-10 py-3 rounded-full'>Generate</button>
    </div>
    }

    {isImageLoaded && 
    <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
      <p onClick={()=>{setIsImageLoaded(false)}} className='bg-tranparent border border-zinc-900 text-black cursor-pointer rounded-full px-8 py-3'>Generate Another</p>
